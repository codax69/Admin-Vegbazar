...
import { User, Mail, Lock, Shield, Eye, EyeOff, CheckCircle, AlertCircle } from 'lucide-react';
      ...
      <div className="max-w-md w-full space-y-8">
        <div className="bg-white rounded-2xl shadow-2xl p-8 border border-green-100">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-green-600 mt-2 font-medium">Create your admin account</p>
          </div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-4 py-3 border rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors ${
                    errors.username ? 'border-red-500 bg-red-50' : 'border-gray-300 hover:border-green-300'
                  }`}
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-12 py-3 border rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors ${
                    errors.password ? 'border-red-500 bg-red-50' : 'border-gray-300 hover:border-green-300'
                  }`}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full pl-10 pr-12 py-3 border rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors ${
                    errors.confirmPassword ? 'border-red-500 bg-red-50' : 'border-gray-300 hover:border-green-300'
                  }`}
        ...
        <div className="text-center">
          <p className="text-sm text-green-600 font-medium">
            🥬 Fresh vegetables, delivered fresh to your doorstep 🥕
          </p>
        </div>
      </div>
    </div>
