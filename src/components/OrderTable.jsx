...
const OrderTable = () => {
  ...
  const filteredOrders = orders.filter((order) => {
    ...
    const matchesPayment =
      filterPayment === "" || order.paymentStatus.toLowerCase() === filterPayment.toLowerCase();
    ...
    <div className="bg-white rounded-lg shadow-md border border-gray-200 p-3 sm:p-4 mb-3 sm:mb-4 hover:shadow-lg transition-shadow">
      <div className="flex justify-between items-start mb-3">
        <div className="flex-1 min-w-0">
          <h3 className="font-bold text-base sm:text-lg text-gray-900 truncate">{order.orderId}</h3>
      ...
      <div className="flex justify-between items-center pt-3 border-t border-gray-200">
        ...
        <div className="text-right ml-2">
          <p className="text-lg sm:text-xl font-bold text-gray-900">₹{order.amount}</p>
        </div>
      </div>
          ...
          <div className="px-4 sm:px-6 py-4">
            ...
            <div className="space-y-2">
              {statusOptions.map((option) => (
                <button
                  key={option.value}
                  onClick={() => updateOrderStatus(selectedOrderForUpdate._id, option.value)}
                ...
                >
                  {option.label}
                  {selectedOrderForUpdate.status === option.value && " (Current)"}
                </button>
              ))}
            </div>
          </div>
        ...
        <div className="bg-white p-3 sm:p-4 rounded-lg shadow border">
          <div className="text-center">
            <p className="text-xl sm:text-2xl font-bold text-yellow-600">
              {filteredOrders.filter((o) => o.status?.toLowerCase() === "processing" || o.status?.toLowerCase() === "processed").length}
            </p>
        ...
        <div className="bg-white p-3 sm:p-4 rounded-lg shadow border">
          <div className="text-center">
            <p className="text-xl sm:text-2xl font-bold text-blue-600">
              {filteredOrders.filter((o) => o.status?.toLowerCase() === "placed" || o.status?.toLowerCase() === "pending").length}
            </p>
        ...
        <div className="bg-white p-3 sm:p-4 rounded-lg shadow border col-span-2 sm:col-span-1">
          <div className="text-center">
            <p className="text-xl sm:text-2xl font-bold text-emerald-600">
              {filteredOrders.filter((o) => o.paymentStatus?.toLowerCase() === "completed" || o.paymentStatus?.toLowerCase() === "paid").length}
            </p>
      ...
      {viewMode === "table" && (
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
            ...
            <table className="min-w-full">
              <thead className="bg-gray-50">
                <tr className="text-left text-gray-600">
                  ...
                  <th className="px-4 py-3 text-xs font-medium uppercase tracking-wider">Phone</th>
                  <th className="px-4 py-3 text-xs font-medium uppercase tracking-wider">Location</th>
                  <th className="px-4 py-3 text-xs font-medium uppercase tracking-wider">Package</th>
                  <th className="px-4 py-3 text-xs font-medium uppercase tracking-wider">Items</th>
                  <th className="px-4 py-3 text-xs font-medium uppercase tracking-wider">Amount</th>
                  <th className="px-4 py-3 text-xs font-medium uppercase tracking-wider">Payment</th>
                ...
                {filteredOrders.length > 0 ? (
                  filteredOrders.map((order) => (
                    <tr key={order.orderId} className="hover:bg-gray-50 transition-colors">
                      <td className="px-4 py-3 text-sm font-bold text-blue-600">{order.orderId}</td>
                      <td className="px-4 py-3 text-sm text-gray-600 whitespace-nowrap">{order.date?.split(" ")[0]}</td>
                      <td className="px-4 py-3 text-sm font-medium text-gray-900 whitespace-nowrap">{order.customerName}</td>
                      <td className="px-4 py-3 text-sm text-gray-600 whitespace-nowrap">{order.phone}</td>
                      <td className="px-4 py-3 text-sm text-gray-600 whitespace-nowrap max-w-xs truncate">
                        {order.area}, {order.city}
                      </td>
                      <td className="px-4 py-3 text-sm font-medium text-gray-700 whitespace-nowrap">{order.package}</td>
          ...
          <div className="block lg:hidden divide-y divide-gray-200">
            {filteredOrders.length > 0 ? (
              filteredOrders.map((order) => (
                <div key={order.orderId} className="p-3 sm:p-4 hover:bg-gray-50">
                  ...
                  <div className="mb-2">
                    <p className="font-medium text-gray-700 text-sm truncate">{order.customerName}</p>
                    <p className="text-xs text-gray-500">{order.phone}</p>
                  </div>
                  <div className="flex justify-between items-center flex-wrap gap-2">
                    <span className="text-base sm:text-lg font-bold text-green-600">₹{order.amount}</span>
                    <div className="flex space-x-2">
                      <button
                        onClick={() => setSelectedOrder(order)}
          ...
          <div className="bg-white rounded-lg shadow-xl w-full max-w-4xl my-4 max-h-[95vh] overflow-y-auto">
            ...
            <div className="px-4 sm:px-6 py-4 space-y-4 sm:space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                <div className="bg-gray-50 p-3 sm:p-4 rounded-lg">
                  ...
                  <div className="space-y-2 text-xs sm:text-sm">
                    ...
                    <p>
                      <span className="font-medium text-gray-600">Date:</span> {selectedOrder.date}
                    </p>
                    <p>
                    ...
                    <p className="break-words">
                      <span className="font-medium text-gray-600">Package:</span> {selectedOrder.package}
                    </p>
                  </div>
                </div>
              ...
              <div className="bg-gray-50 p-3 sm:p-4 rounded-lg">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3 text-xs sm:text-sm">
                  ...
                  <p className="break-all">
                    <span className="font-medium text-gray-600">Email:</span> {selectedOrder.email}
                  </p>
                  <p>
                  ...
                  <p>
                    <span className="font-medium text-gray-600">City:</span> {selectedOrder.city}
                  </p>
                  <p>
                    <span className="font-medium text-gray-600">Area:</span> {selectedOrder.area}
                  </p>
                  <p>
                    <span className="font-medium text-gray-600">State:</span> {selectedOrder.state}
                  </p>
                  <p className="col-span-1 sm:col-span-2 break-words">
                    <span className="font-medium text-gray-600">Address:</span> {selectedOrder.address}
                  </p>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-green-50 to-blue-50 p-3 sm:p-4 rounded-lg border-2 border-green-200">
                <h4 className="font-semibold text-sm sm:text-base text-gray-700 mb-3 flex items-center">
                  <span className="text-green-600 mr-2">💰</span> Price Breakdown
                </h4>
                <div className="space-y-2 text-xs sm:text-sm">
                  <div className="flex justify-between">
                    <span className="text-gray-600">Vegetables Total:</span>
                    <span className="font-bold">₹{selectedOrder.vegetablesTotal}</span>
                  </div>
                  {selectedOrder.offerPrice > 0 && (
                    <div className="flex justify-between">
                      <span className="text-gray-600">Offer Price:</span>
                      <span className="font-bold text-purple-600">₹{selectedOrder.offerPrice}</span>
                    </div>
                  )}
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-bold">₹{selectedOrder.deliveryCharges}</span>
                  </div>
                  <div className="flex justify-between pt-2 border-t-2 border-green-300">
                    ...
                    <span className="text-xl sm:text-2xl font-bold text-green-600">₹{selectedOrder.amount}</span>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="hidden lg:block overflow-x-auto">
                  <table className="w-full text-sm border-collapse border border-gray-300">
                    <thead className="bg-gradient-to-r from-green-600 to-green-700 text-white">
                      <tr>
                        <th className="px-3 py-2 text-left font-semibold border border-gray-300">Vegetable</th>
                        <th className="px-3 py-2 text-center font-semibold border border-gray-300">Weight</th>
                        <th className="px-3 py-2 text-center font-semibold border border-gray-300">Qty</th>
                        <th className="px-3 py-2 text-right font-semibold border border-gray-300">VegBazar</th>
                        <th className="px-3 py-2 text-right font-semibold border border-gray-300">Market</th>
                        <th className="px-3 py-2 text-right font-semibold border border-gray-300">Subtotal</th>
                        <th className="px-3 py-2 text-right font-semibold border border-gray-300">Save</th>
                        <th className="px-3 py-2 text-right font-semibold border border-gray-300">%</th>
                      </tr>
                    </thead>
                    <tbody>
                      {selectedOrder.vegetables.map((veg, index) => {
                        ...
                        const totalMarketPrice = (marketPrice * veg.quantity).toFixed(2);
                        const totalSavings = (totalMarketPrice - subtotal).toFixed(2);
                        const savingsPercent = marketPrice > 0 ? ((savings / marketPrice) * 100).toFixed(1) : 0;

                        return (
                          <tr key={index} className="border border-gray-300 hover:bg-green-50">
                            ...
                            <td className="px-3 py-2 text-center font-medium text-gray-700 border border-gray-300">{veg.weight}</td>
                            <td className="px-3 py-2 text-center font-bold text-gray-800 border border-gray-300">{veg.quantity}</td>
                            <td className="px-3 py-2 text-right font-bold text-blue-600 border border-gray-300">₹{vegBazarPrice}</td>
                            <td className="px-3 py-2 text-right font-bold text-gray-700 border border-gray-300">₹{marketPrice}</td>
                            <td className="px-3 py-2 text-right font-bold text-green-700 border border-gray-300">₹{subtotal}</td>
                      ...
                      <tr className="bg-gray-100 font-bold text-sm">
                        <td colSpan="5" className="px-3 py-2 text-right border border-gray-300">Total:</td>
                ...
                <div className="lg:hidden space-y-3">
                  {selectedOrder.vegetables.map((veg, index) => {
                    ...
                    return (
                      <div key={index} className="bg-gradient-to-br from-green-50 to-blue-50 p-3 sm:p-4 rounded-lg border-2 border-green-200 shadow">
                        <div className="flex justify-between items-start mb-3">
                          <div className="flex-1 min-w-0">
                            <p className="font-bold text-gray-800 text-sm sm:text-base break-words">{veg.name}</p>
                        ...
                        <div className="grid grid-cols-2 gap-2 sm:gap-3 mb-2 sm:mb-3">
                          <div className="bg-white p-2 sm:p-3 rounded-lg border border-blue-200">
                            <p className="text-gray-600 text-xs mb-1">VegBazar</p>
                            <p className="text-sm sm:text-base font-bold text-blue-600">₹{vegBazarPrice}</p>
                          </div>
                          <div className="bg-white p-2 sm:p-3 rounded-lg border border-gray-300">
                            <p className="text-gray-600 text-xs mb-1">Market</p>
                            <p className="text-sm sm:text-base font-bold text-gray-700">₹{marketPrice}</p>
                          </div>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-2 sm:gap-3">
                          <div className="bg-green-700 p-2 sm:p-3 rounded-lg">
                            ...
                            <p className="text-base sm:text-lg font-bold text-white">₹{subtotal}</p>
                          </div>
                          <div className="bg-green-600 p-2 sm:p-3 rounded-lg">
                            <p className="text-white text-xs mb-1">You Save</p>
                            <p className="text-base sm:text-lg font-bold text-white">₹{totalSavings}</p>
                          </div>
                        </div>
                      </div>
                    );
                  ...
                  <div className="bg-gradient-to-r from-green-600 to-green-700 p-3 sm:p-4 rounded-lg shadow-lg">
                    <div className="flex justify-between items-center text-white">
                      <div>
                        <p className="text-xs sm:text-sm opacity-90">Total Saved</p>
                      ...
                      <div className="text-right">
                        <p className="text-xs sm:text-sm opacity-90">Your Total</p>
            ...
            <div className="px-4 sm:px-6 py-3 sm:py-4 border-t border-gray-200 bg-gray-50 sticky bottom-0">
              <div className="grid grid-cols-2 sm:flex sm:flex-wrap gap-2">
                <button
                  onClick={() => handleQuickStatusUpdate(selectedOrder, "delivered")}
                ...
                <button
                  onClick={() => handleQuickStatusUpdate(selectedOrder, "processed")}
