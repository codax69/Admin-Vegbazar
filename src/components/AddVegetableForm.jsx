...
const AddVegetableForm = () => {
    ...
    const addVegetable = async (payload) => {
        try {
            await axios.post(`${import.meta.env.VITE_API_SERVER_URL}/api/vegetables/add`, payload);
    ...
    return (
        <div className="min-h-screen bg-gray-100 py-4 px-4 sm:py-6 flex flex-col justify-center">
            ...
            <div className="block sm:hidden mb-4">
                <h1 className="text-2xl font-bold text-gray-900 text-center">Add New Vegetable</h1>
            </div>
                    ...
                    <div className="w-full">
                        ...
                        <div className="hidden sm:flex items-center space-x-5 mb-6">
                            <div className="block pl-2 font-semibold text-xl sm:text-2xl text-gray-700">
                                ...
                                <p className="text-sm text-gray-500 mt-1">Fill in the details to add a new vegetable to your inventory</p>
                            </div>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="space-y-4 sm:space-y-6">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    />
                                    {errors.vegetableName && (
                                        <p className="mt-1 text-sm text-red-600">{errors.vegetableName}</p>
                                    )}
                                </div>
                        ...
                        {(formData.vegetableName || formData.stock || formData.image) && (
                            <div className="mt-6 sm:mt-8 pt-6 border-t border-gray-200">
                                <h3 className="text-sm sm:text-lg font-semibold text-gray-700 mb-3">Live Preview</h3>
