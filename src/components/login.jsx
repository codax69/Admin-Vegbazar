...
const Login = () => {
    ...
    const LoginApiCall = async () => {
        ...
        try {
            const response = await axios.post(`${import.meta.env.VITE_API_SERVER_URL}/api/auth/login`, formData);
            ...
            <div className="relative w-full max-w-md">
                <div className="bg-white/80 backdrop-blur-lg shadow-2xl rounded-2xl p-8 border border-white/20">
                    ...
                    <div className="text-center mb-8">
                        ...
                        <p className="text-gray-600 mt-2">Sign in to your Vegbazar account</p>
                    </div>
